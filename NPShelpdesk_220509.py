...
def ilban():
    ...
    txt_Scene3_1_annae_1_label.place(x = 360, y = 200)
    txt_Scene3_1_annae_2_label.place(x = 360, y = 300)
    
    button_ilban_cheoum = Button(text = "처음으로")
    button_ilban_cheoum.place(x = 640, y = 540)
...
def saupjang():
    ...
    txt_Scene4_1_annae_1_label.place(x = 360, y = 200)
    txt_Scene4_1_annae_2_label.place(x = 360, y = 300)

    button_saupjang_cheoum = Button(text = "처음으로")
    button_saupjang_cheoum.place(x = 640, y = 540)
...
def jiyeok():
    ...
    txt_Scene4_annae_1_label.place(x = 360, y = 200)
    txt_Scene4_annae_2_label.place(x = 360, y = 300)

    button_jiyeok_cheoum = Button(text = "처음으로")
    button_jiyeok_cheoum.place(x = 640, y = 540)
...
def go_to_Scene3():
    ...
    txt_Scene3_annae_1_label.place(x = 360, y = 200)
    txt_Scene3_annae_2_label.place(x = 360, y = 300)
    txt_Scene3_annae_3_label.place(x = 360, y = 400)
    txt_Scene3_annae_4_label.place(x = 360, y = 500)

    button_Scene3_ilban = Button(text = "일반상담")
    button_Scene3_saupjang = Button(text = "사업장")
    button_Scene3_jiyeok = Button(text = "지역")
    button_Scene3_ilban.place(x = 360, y = 600)
    button_Scene3_saupjang.place(x = 540, y = 600)
    button_Scene3_jiyeok.place(x = 960, y = 600)
...
def yeonjiboo():
    ...
    txt_Scene2_1_annae_1_label.place(x = 360, y = 200)
    txt_Scene2_1_annae_2_label.place(x = 360, y = 300)
    
    button_yeonjiboo_cheoum = Button(text = "처음으로")
    button_yeonjiboo_cheoum.place(x = 640, y = 540)
...
def go_to_Scene2():
    ...
    txt_Scene2_annae_1_label.place(x = 320, y = 200)
    txt_Scene2_annae_2_label.place(x = 320, y = 300)
    txt_Scene2_annae_3_label.place(x = 320, y = 400)
    txt_Scene2_annae_4_label.place(x = 320, y = 500)

    button_Scene2_yeonjiboo = Button(text = "연금지급부")
    button_Scene2_daum = Button(text = "다음")
    button_Scene2_yeonjiboo.place(x = 320, y = 600)
    button_Scene2_daum.place(x = 960, y = 600)
...
def yoojok():
    ...
    txt_yoojok_annae1_label.place(x = 400, y = 180)
    txt_yoojok_annae2_label.place(x = 400, y = 360)
    button_yoojok_cheoum = Button(text = "처음으로")
    button_yoojok_cheoum.place(x = 640, y = 540)
...
def jangae():
    ...
    txt_jangae_annae1_label.place(x = 400, y = 180)
    txt_jangae_annae2_label.place(x = 400, y = 360)

    button_jangae_cheoum = Button(text = "처음으로")
    button_jangae_cheoum.place(x = 640, y = 540)
...
def noryung():
    ...
    txt_noryung_annae1_label.place(x = 400, y = 180)
    txt_noryung_annae2_label.place(x = 400, y = 360)

    button_noryung_cheoum = Button(text = "처음으로")
    button_noryung_cheoum.place(x = 640, y = 540)
...
def banhwan():
    ...
    txt_banhwan_annae1_label.place(x = 400, y = 180)
    txt_banhwan_annae2_label.place(x = 400, y = 360)

    button_banhwan_cheoum = Button(text = "처음으로")
    button_banhwan_cheoum.place(x = 640, y = 540)
...
def go_to_Scene1_1():
    ...
    txt_Scene1_1_annae_1_label.place(x = 300, y = 100)
    txt_Scene1_1_annae_2_label.place(x = 300, y = 200)
    txt_Scene1_1_annae_3_label.place(x = 300, y = 300) 
    txt_Scene1_1_annae_4_label.place(x = 300, y = 400)

    button_Scene1_1_yoojok = Button(text = "노령연금")
    button_Scene1_1_jangae = Button(text = "반환일시금")
    button_Scene1_1_noryung = Button(text = "유족연금")
    button_Scene1_1_banhwan = Button(text = "장애연금")
    button_Scene1_1_yoojok.place(x = 300, y = 540)
    button_Scene1_1_jangae.place(x = 500, y =540)
    button_Scene1_1_noryung.place(x = 700, y = 540)
    button_Scene1_1_banhwan.place(x = 900, y = 540)

    button_Scene1_1_yoojok.config(command = noryung)
    button_Scene1_1_jangae.config(command = banhwan)
    button_Scene1_1_noryung.config(command = yoojok)
    button_Scene1_1_banhwan.config(command = jangae)
    #---------------------------------------------------------------
#<<<<<<<<<<<<<<<<<<<<<<<<<Scene1 branch end>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
def annae_shijak():
    ...
    txt_Scene1_annae_1_label.place(x = 640, y = 180)
    txt_Scene1_annae_2_label.place(x = 640, y = 360)

    button_Scene1_shinchung = Button(win, text = "신청")
    button_Scene1_daum = Button(win, text = "다음")
    button_Scene1_shinchung.place(x = 640, y = 540)
    button_Scene1_daum.place(x = 960, y = 540)
...
current_time_label.place(x = 1000, y = 0)
...
txt_Scene0_annae_1_label.place(x = 640, y = 180)
txt_Scene0_annae_2_label.place(x = 640, y = 360)

button_annae = Button(win, text = "안내")
button_annae.place(x = 640, y = 540)
